...
#define SECURE_CONNECTIONS_USER_MODE SC_IS_MANDATORY //SC_IS_NOT_SUPPORTED 
...
/** 
  * @brief Secure Connections support level
*/
#define SECURE_CONNECTION_SUPPORT  SECURE_CONNECTIONS_USER_MODE /* Supported &  mandatory:  it forces LE Secure connections if peripheral supports it with at least SC_IS_SUPPORTED option (only option for triggering Numeric Comparison)  */
...
/**
 * @brief LE PHY .
 * This defines the PHY used for the scanning/connection procedures
 */   
#define LE_PHY LE_1M_PHY_BIT
   
/**
 * @brief Scan  filter policy.
 * This defines the scan filter  policy on scanning procedure
 */    
#define SCAN_FILTER_POLICY 0

/**
 * @brief Scan type.
 * This defines the scan policy on scanning procedure
 */    
#define SCAN_TYPE 0 

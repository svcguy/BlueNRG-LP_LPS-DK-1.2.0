 ...
 * These constants and variables are used from the BlueNRG-LP stack to reserve RAM and FLASH 
...
#define NUM_APP_GATT_SERVICES_CONF 1  /* 1 service */

/* Number of attributes requests from the demo */
#define NUM_APP_GATT_ATTRIBUTES_CONF 5 /* 5 attributes x BLE Security Peripheral service characteristics */

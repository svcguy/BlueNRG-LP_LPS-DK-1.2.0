...
#define SECURITY_SUPPORTED  SC_IS_SUPPORTED //SC_IS_NOT_SUPPORTED 
...
*/
#define SECURE_CONNECTION_SUPPORT  SECURITY_SUPPORTED /* Supported &  optional:  Legacy Pairing may be accepted */
/** 

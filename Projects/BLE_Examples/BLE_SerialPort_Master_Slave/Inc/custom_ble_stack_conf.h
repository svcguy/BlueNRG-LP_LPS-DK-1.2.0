...
/* This specific set of modular configuration options is used for configuring the Bluetooth Low Energy stacl 
   ONLY when BLE_STACK_CUSTOM_CONF is defined on user application prepropcessor options */

...
/**
 * @brief This callback function returns the service discovery information. Call this function inside the aci_att_clt_find_by_type_value_resp_event()
...
/**
 * @brief This callback function returns the characteristic discovery information. Call this function inside the aci_gatt_clt_disc_read_char_by_uuid_resp_event()
 * @param conn_handle Connection handle
 * @param Num_of_Handle_Pair Number of attribute, group handle pairs
 * @param Attribute_Group_Handle_Pair Attribute group handle pairs data
 * @retval None
...
/**
 * @brief This callback function returns the extended properties information. Call this function inside the aci_att_clt_find_info_resp_event()
...
/**
 * @brief This callback function is called when a GATT procedure is ended. Call this function inside the aci_gatt_clt_proc_complete_event()
...
/**
 * @brief This callback function is called when a read response event is received. Call this function inside the aci_att_clt_read_resp_event()
 * @param Connection_Handle Connection handle related to the response
...
/**
 * @brief This function is called when a notification is received. Call this function inside the aci_gatt_clt_notification_event()
 * @param Connection_Handle Connection handle related to the response

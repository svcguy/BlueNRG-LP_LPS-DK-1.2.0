...
* Description        : Code demonstrating a simple remote control application
********************************************************************************
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Project\\BLE_Examples\\BLE_RemoteControl\\MDK-ARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\BLE_RemoteControl.uvprojx</tt> 
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Project\\BLE_Examples\\BLE_RemoteControl\\EWARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\BLE_RemoteControl.eww</tt> 
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Project\\BLE_Examples\\BLE_RemoteControl\\WiSE-Studio\\{STEVAL-IDB011V1|STEVAL-IDB012V1}</tt> 
  -# Select desired configuration to build
...
|     DL2    |  Led under remote control  |  Led under remote control  |  Led under remote control  |
|     DL3    |  Led under remote control  |  Led under remote control  |  Led under remote control  |
|     DL4    |          Not Used          |          Not Used          |          Not Used          |
|     U5     |  Led under remote control  |  Led under remote control  |  Led under remote control  |
...
This demo shows how to control a remote device (like an attuator) using BlueNRG-LP.

The device is connectable and exposes a characteristic used to control the LEDs (LED1, LED2, LED3) on the
eval board. The value of this characteristic is a bitmap of 1 byte. Each bit controls one of the LEDs:
bit 0 (i.e. the least significant bit) is the status of LED1 (1 for LED ON, 0 for LED OFF), bit 
is the status of LED2, while bit 2 is the status of LED3. Hence, a remote device can connect and write 
this byte to change or read the status of these LEDs. The peripheral will disconnect after a timeout
(DISCONNECT_TIMEOUT), to avoid a central to be always connected to the device.
...
Use a Bluetooth LE device (another BlueNRG-LP or any SMART READY device), to scan and see broadcast data.
To control one of the LEDs, just connect to BlueNRG-LP  and write into the exposed characteristic.
 ...
 * BlueNRG-LP Remote Control demo \see BLE_RC_main.c for documentation.
 *
 *@{
 */

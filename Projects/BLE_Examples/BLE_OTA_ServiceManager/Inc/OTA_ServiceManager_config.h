...
/* Number of attributes (service + characteristics) requests from the OTA Service manager application */
#define NUM_APP_GATT_ATTRIBUTES_CONF (1 + 9)
...
#if (CONTROLLER_DATA_LENGTH_EXTENSION_ENABLED == 1) && (CONFIG_SW_OTA_DATA_LENGTH_EXT == 1) 
  #define MAX_ATT_MTU_CONF  (OTA_ATT_MTU_SIZE_CONF)         /* OTA Client & Server supported ATT_MTU */   
#else /* No extended packet length support */

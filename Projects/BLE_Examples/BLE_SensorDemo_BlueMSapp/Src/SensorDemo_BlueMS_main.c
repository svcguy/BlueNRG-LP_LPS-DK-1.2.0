...
* Description        : BlueNRG-LP Sensor Demo main for interacting with ST 
*                      BlueMS/BLE Sensor smarthphone app (wiht Bluevoice)
********************************************************************************
...
int main(void) 
{
  ...
  BSP_LED_Init(BSP_LED3); //Error led and ....
  BSP_LED_On(BSP_LED1);
...
{
#if ENABLE_BLUEVOICE 
  if((AudioNotification) || (SyncNotification))

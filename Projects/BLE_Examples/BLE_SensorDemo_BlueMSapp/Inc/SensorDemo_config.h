...
/* Number of services */
#define NUM_APP_GATT_SERVICES_CONF  (1)       /* attributes x acceleration and enviromental sensors services */

/* Number of characteristics attributes requests */
#if ENABLE_BLUEVOICE
#define NUM_APP_GATT_CHAR_ATTRIBUTES_CONF (7 + 6)
#else
#define NUM_APP_GATT_CHAR_ATTRIBUTES_CONF (7) /* attributes x acceleration and enviromental sensors services characteristics */
#endif 

#if defined (CONFIG_OTA_LOWER) || defined (CONFIG_OTA_HIGHER)

/* Number of services requests from OTA */

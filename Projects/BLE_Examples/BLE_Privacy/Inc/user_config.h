...
These constants and variables are used from the BLE stack to reserve RAM and FLASH according the application requests. */
...
#define NUM_APP_GATT_ATTRIBUTES_CONF	(3)

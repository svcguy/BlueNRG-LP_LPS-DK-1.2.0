#ifndef _POWERCONTROL_CONFIG_H_
#define _POWERCONTROL_CONFIG_H_

#include "bluenrg_lp_stack.h"
#include "stack_user_cfg.h"

/* This file contains all the information needed to init the BLE stack v3.x. 
 * These constants and variables are used from the BLE stack v3.x stack to reserve RAM and FLASH 
...
/* Number of services requests from the power control demo */
#define NUM_APP_GATT_SERVICES_CONF 1

/* Number of attributes requests from the power control demo */
...
/* Number of attributes needed for the power control demo. */
...
#define OPT_MBLOCKS_CONF		(0) /* 6:  for reaching the max throughput: ~220kbps (same as BLE stack 1.x) */

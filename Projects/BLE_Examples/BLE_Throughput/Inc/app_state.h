...
#define IDX_FEAT_EXCHANGE_REQ                   (18)
#define IDX_FEAT_EXCHANGED                      (19)
#define IDX_L2C_COS_TX                          (20)
#define IDX_DISABLE_NOTIFY                      (21)
...
#define FEAT_EXCHANGE_REQ                       (1 << IDX_FEAT_EXCHANGE_REQ)
#define FEAT_EXCHANGED                          (1 << IDX_FEAT_EXCHANGED)
#define L2C_COS_TX                              (1 << IDX_L2C_COS_TX)
#define DISABLE_NOTIFY                          (1 << IDX_DISABLE_NOTIFY)
/**
 * @}
 */

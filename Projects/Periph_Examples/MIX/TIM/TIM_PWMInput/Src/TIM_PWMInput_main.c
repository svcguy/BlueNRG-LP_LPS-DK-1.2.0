...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\MIX\\TIM\\TIM_PWMInput\\MDK-ARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\TIM_PWMInput.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\MIX\\TIM\\TIM_PWMInput\\EWARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\TIM_PWMInput.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\MIX\\TIM\\TIM_PWMInput\\WiSE-Studio\\{STEVAL-IDB011V1|STEVAL-IDB012V1}</tt> 
  -# Select desired configuration to build
...
TIM1 is configured in PWM Input Mode: the external signal is connected to TIMx Channel2 used as input pin.
...
uwFrequency = TIMx counter clock / TIMx_CCR2 in Hz

"uwDutyCycle" variable contains the external signal duty cycle:
uwDutyCycle = (TIMx_CCR1*100)/(TIMx_CCR2) in %.

The minimum frequency value to measure is (TIMx counter clock / CCR MAX)
                                         = (64 MHz/1)/ 65535
                                         = 915,5 Hz

BlueNRG_LP-EVB Set-up
- TIMx_CH2   the external signal must be connected to TIMx Channel2 used as input pin.

...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\MIX\\SPI\\SPI_Polling_Master\\MDK-ARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\SPI_Polling_Master.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\MIX\\SPI\\SPI_Polling_Master\\EWARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\SPI_Polling_Master.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\MIX\\SPI\\SPI_Polling_Master\\WiSE-Studio\\{STEVAL-IDB011V1|STEVAL-IDB012V1}</tt> 
  -# Select desired configuration to build
...
------------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |   Start a Full-Duplex communication  |   Start a Full-Duplex communication  |   Start a Full-Duplex communication  |
...
int main(void)
{
  ...
  while(ubNbDataToReceive > 0)
  {
    ...
    if(( LL_SPI_IsActiveFlag_TXE(hspiMaster.Instance)) && (ubNbDataToTransmit > 0))
    {
#if defined( CONFIG_DATASIZE_16BIT ) 
      /* Transmit 16bit Data */
      LL_SPI_TransmitData16(hspiMaster.Instance, aTxBuffer[ubTransmitIndex++]);
      ubNbDataToTransmit--;  
#elif defined( CONFIG_DATASIZE_8BIT )
      /* Transmit 8bit Data */
      LL_SPI_TransmitData8(hspiMaster.Instance, aTxBuffer[ubTransmitIndex++]);
      ubNbDataToTransmit--;  
#endif 
    }
    /* Check RXE flag */
    if(LL_SPI_IsActiveFlag_RXNE(hspiMaster.Instance))
    {
#if defined( CONFIG_DATASIZE_16BIT ) 
      /* Receive 16bit Data */
      aRxBuffer[ubReceiveIndex++] = LL_SPI_ReceiveData16(hspiMaster.Instance);
      ubNbDataToReceive--;
#elif defined( CONFIG_DATASIZE_8BIT )
      /* Receive 16bit Data */
      aRxBuffer[ubReceiveIndex++] = LL_SPI_ReceiveData8(hspiMaster.Instance);
      ubNbDataToReceive--;
#endif 
    }
  }
  ...
  {
    /* Transfer in transmission/reception process is correct */

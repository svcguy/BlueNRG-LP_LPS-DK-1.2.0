...
* Version            : 1.0.0
* Date               : 04-March-2019
* Description        : Code demonstrating the PDM functionality
********************************************************************************
...
/**
 * @file  PDM_DiglMic/PDM_DiglMic_main.c
 * @brief This example shows how to use the PDM peripheral to interface a digital
 * microphone.
 *
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\LL\\PDM\\PDM_DiglMic\\MDK-ARM\\STEVAL-IDB011V1\\PDM_DiglMic.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\LL\\PDM\\PDM_DiglMic\\EWARM\\STEVAL-IDB011V1\\PDM_DiglMic.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\LL\\PDM\\PDM_DiglMic\\WiSE-Studio\\STEVAL-IDB011V1</tt> 
  -# Select desired configuration to build
...
This example shows how to use the PDM port to interface a digital microphone. 
The DMA peripheral is used to transfer the data from the ADC output register to the RAM memory. 
...
The ADC is configured to sample the output data coming from the digital microphone connected to the Decimation Filter through the PDM port.
...
Example execution:
The BlueNRG-LP provides also a clock for the digital microphone from the pin PB1. The specific clock frequency can be set by user.
The input port is the pin PB2.
...
volatile uint8_t AudioVolume = 5;

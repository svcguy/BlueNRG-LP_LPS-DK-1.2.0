...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\LL\\ADC\\ADC_BatterySensor\\MDK-ARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\ADC_BatterySensor.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\LL\\ADC\\ADC_BatterySensor\\EWARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\ADC_BatterySensor.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\LL\\ADC\\ADC_BatterySensor\\WiSE-Studio\\{STEVAL-IDB011V1|STEVAL-IDB012V1}</tt> 
  -# Select desired configuration to build
...
|     DL2    |   Overflow detect  |   Overflow detect  |   Overflow detect  |
...
int main(void)
{
  ...
  while (1) {
    ...
    if( LL_ADC_IsActiveFlag_EODS(ADC) == 1) {
      ...
      adcValue = (float)LL_ADC_GetADCConvertedValueBatt(ADC, nVBattRawVal, USER_DATAWIDTH, offset_vinm0);

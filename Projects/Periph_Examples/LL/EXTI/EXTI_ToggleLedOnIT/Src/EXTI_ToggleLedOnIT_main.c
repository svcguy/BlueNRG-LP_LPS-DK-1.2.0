...
|     DL2    |   ON: PUSH1 rising edge is detected  |   ON: PUSH1 rising edge is detected  |   ON: PUSH1 rising edge is detected  |
...
------------------------------------------------------------------------------------
|      PUSH1     |   LED2 is toggled  |   LED2 is toggled  |   LED2 is toggled  |

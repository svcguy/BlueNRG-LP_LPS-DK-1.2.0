...
* File Name          : RTC_Alarm_Polling_main.c
...
/**
 * @file  RTC_Alarm_Polling/RTC_Alarm_Polling_main.c
 * @brief This example shows how configure and generate an RTC alarm A in polling mode
 *
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\LL\\RTC\\RTC_Alarm_Polling\\MDK-ARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\RTC_Alarm_Polling.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\LL\\RTC\\RTC_Alarm_Polling\\EWARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\RTC_Alarm_Polling.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\LL\\RTC\\RTC_Alarm_Polling\\WiSE-Studio\\{STEVAL-IDB011V1|STEVAL-IDB012V1}</tt> 
  -# Select desired configuration to build
...
In this example, the Time is set to 23:59:50 and the Alarm must be generated in polling mode on 00:00:00.
...
LED2 is turned ON when the RTC Alarm in polling mode is generated correctly.
...
int main(void)
{
  ...
  printf("RTC_Alarm_Polling example is started.\n\r");
  ...
  while(1)
  {
    ...
    /* Check the status of the Alarm Interrupt */

...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\LL\\TIM\\TIM_PWMOutput_Init\\MDK-ARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\TIM_PWMOutput_Init.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\LL\\TIM\\TIM_PWMOutput_Init\\EWARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\TIM_PWMOutput_Init.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\LL\\TIM\\TIM_PWMOutput_Init\\WiSE-Studio\\{STEVAL-IDB011V1|STEVAL-IDB012V1}</tt> 
  -# Select desired configuration to build
...
------------------------------------------------------------------------------------------
|      PUSH1     |   Change duty cycle  |   Change duty cycle  |   Change duty cycle  |
...
int main(void)
{
  ...
  timxPrescaler = __LL_TIM_CALC_PSC(LL_TIM_GetPeriphClock(TIMx), 10000);
  timxPeriod = __LL_TIM_CALC_ARR(LL_TIM_GetPeriphClock(TIMx), timxPrescaler, 100); 
  ...
  printf("User push-button (PUSH1)  or 'c'/'C' character can be used to change the duty cycle from 0%% up to 100%% by steps of 10%%. \n\r");  
...
__STATIC_INLINE void Configure_DutyCycle(uint32_t D)
{
  ...
  T = LL_TIM_GetAutoReload(TIMx) + 1;
  
  /* Pulse duration is determined by the value of the compare register.       */
  /* Its value is calculated in order to match the requested duty cycle.      */
  P = (D*T)/100;
  LL_TIM_OC_SetCompareCH1(TIMx, P);

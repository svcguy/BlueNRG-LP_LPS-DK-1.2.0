...
* File Name          : CRC_UserDefPol_main.c
...
/**
 * @file  CRC_UserDefPol/CRC_UserDefPol_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\LL\\CRC\\CRC_UserDefPol\\MDK-ARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\CRC_UserDefPol.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\LL\\CRC\\CRC_UserDefPol\\EWARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\CRC_UserDefPol.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\LL\\CRC\\CRC_UserDefPol\\WiSE-Studio\\{STEVAL-IDB011V1|STEVAL-IDB012V1}</tt> 
  -# Select desired configuration to build
...
How to configure and use the CRC calculation unit to compute an 8-bit CRC code for a given data buffer, based on a user-defined generating polynomial. 
...
Once calculated, CRC value (ubCRCValue) is compared to the CRC expected value (ubExpectedCRCValue), and if both are equal, LED2 is turned On. 
...
void CheckCRCResultValue(void)
{
  ...
  else
  {
    ...
    printf("%#X\tubCRCValue\n\r", ubCRCValue);
    printf("%#X\tubExpectedCRCValue\n\r", ubExpectedCRCValue);

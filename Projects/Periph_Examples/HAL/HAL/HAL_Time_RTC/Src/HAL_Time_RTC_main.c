...
/**
 * @file  HAL_Time_RTC/HAL_Time_RTC_main.c
 * @brief Example of how to customize HAL using RTC alarm as main source of time base, instead of Systick.
 *
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\HAL\\HAL_Time_RTC\\MDK-ARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\HAL_Time_RTC.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\HAL\\HAL_Time_RTC\\EWARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\HAL_Time_RTC.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\HAL\\HAL_Time_RTC\\WiSE-Studio\\{STEVAL-IDB011V1|STEVAL-IDB012V1}</tt> 
  -# Select desired configuration to build
...
------------------------------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |  it is used to suspend the tick increment  |  it is used to suspend the tick increment  |  it is used to suspend the tick increment  |
|      PUSH2     |   it is used to resume the tick increment  |   it is used to resume the tick increment  |   it is used to resume the tick increment  |
...
Each time the button is pressed; an interrupt is generated and in the ISR the uwIncrementState is checked:
...
int main(void)
{
  ...
  printf("When user pushes the User push-button (PUSH1 or PUSH2), the Tick is modified.\n\r");

...
* File Name          : HAL_TimeBase_TIM_main.c
* Author             : RF Application Team
* Version            : 1.0.0
* Date               : 04-March-2019
* Description        : Code demonstrating how to use the HAL time base (TIM)
********************************************************************************
...
/**
 * @file  HAL_TimeBase_TIM/HAL_TimeBase_TIM_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\HAL\\HAL_TimeBase_TIM\\MDK-ARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\HAL_TimeBase_TIM.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\HAL\\HAL_TimeBase_TIM\\EWARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\HAL_TimeBase_TIM.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\HAL\\HAL_TimeBase_TIM\\WiSE-Studio\\{STEVAL-IDB011V1|STEVAL-IDB012V1}</tt> 
  -# Select desired configuration to build
...
|     DL2    |  Blinking: tick increment is on - Toggle: tick increment is suspended  |  Blinking: tick increment is on - Toggle: tick increment is suspended  |  Blinking: tick increment is on - Toggle: tick increment is suspended  |
...
When user pushes the User push-button (PUSH1), the Tick increment is suspended if it is already enabled, else it will be resumed.

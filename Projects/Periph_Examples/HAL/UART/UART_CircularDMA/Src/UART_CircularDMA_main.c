...
* File Name          : UART_CircularDMA_main.c
...
/**
 * @file  UART_CircularDMA/UART_CircularDMA_main.c
 * @brief How to use the HAL UART API for reception in circular DMA mode.
 *
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\UART\\UART_CircularDMA\\MDK-ARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\UART_CircularDMA.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\UART\\UART_CircularDMA\\EWARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\UART_CircularDMA.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\UART\\UART_CircularDMA\\WiSE-Studio\\{STEVAL-IDB011V1|STEVAL-IDB012V1}</tt> 
  -# Select desired configuration to build
...
How to use the HAL UART API for reception in circular DMA mode.
...
Application then starts the Reception process, using dedicated HAL UART API :
    - HAL_UART_Receive_DMA()

Notifications to application, that some data are available in reception buffer, are done
through the execution of a user callback : 
...
USARTx/UARTx instance used and associated resources can be updated in "UART_CircularDMA_main.h"
...
- Connect BlueNRG_LP board USART1 TX pinto PC COM port RX signal
...
/**
  ...
  */
uint8_t aTextInfoStart[] = "\r\nUSART Example : Enter 20 characters to fill reception buffers.\r\n";
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart)
{
  ...
  if (HAL_UART_Transmit(&huart1, (uint8_t *)aRXBufferUser, RX_BUFFER_SIZE, 1000) != HAL_OK)
  {

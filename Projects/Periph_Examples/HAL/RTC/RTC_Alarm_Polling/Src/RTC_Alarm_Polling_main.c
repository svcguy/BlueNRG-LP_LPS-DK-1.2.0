 ...
 * @brief Configuration and generation of an RTC alarm A in polling mode.
 *
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\RTC\\RTC_Alarm_Polling\\MDK-ARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\RTC_Alarm_Polling.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\RTC\\RTC_Alarm_Polling\\EWARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\RTC_Alarm_Polling.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\RTC\\RTC_Alarm_Polling\\WiSE-Studio\\{STEVAL-IDB011V1|STEVAL-IDB012V1}</tt> 
  -# Select desired configuration to build
...
|     DL2    |  On: RTC Alarm is generated  |  On: RTC Alarm is generated  |  On: RTC Alarm is generated  |
...
HAL_RTC_SetAlarm() function is then called to initialize the Alarm feature with polling mode.
...
void RTC_TimeShow(uint8_t *showtime)
{
  ...
  printf("\n\r");
  printf((uint8_t *)aShowTime, sizeof(aShowTime)+1);
}

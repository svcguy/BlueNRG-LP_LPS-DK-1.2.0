...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\CRC\\CRC_UserDefPol\\MDK-ARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\CRC_UserDefPol.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\CRC\\CRC_UserDefPol\\EWARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\CRC_UserDefPol.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\CRC\\CRC_UserDefPol\\WiSE-Studio\\{STEVAL-IDB011V1|STEVAL-IDB012V1}</tt> 
  -# Select desired configuration to build
...
|     DL2    |    ON: CRC is OK   |    ON: CRC is OK   |    ON: CRC is OK   |

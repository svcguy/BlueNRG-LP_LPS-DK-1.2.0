...
/**
 * @file  CRC_Example/CRC_Example_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\CRC\\CRC_Example\\MDK-ARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\CRC_Example.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\CRC\\CRC_Example\\EWARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\CRC_Example.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\CRC\\CRC_Example\\WiSE-Studio\\{STEVAL-IDB011V1|STEVAL-IDB012V1}</tt> 
  -# Select desired configuration to build
...
|     DL2    |                      ON: CRC is OK - Blinking: CRC error                     |                      ON: CRC is OK - Blinking: CRC error                     |                      ON: CRC is OK - Blinking: CRC error                     |
|     DL3    |   ON: incorrect CRC value is calculated or there is an initialization error  |   ON: incorrect CRC value is calculated or there is an initialization error  |   ON: incorrect CRC value is calculated or there is an initialization error  |
...
BlueNRG_LP-EVB LEDs are used to monitor the example status:
  - LED2 is ON when a correct CRC value is calculated
  - LED3 is ON when an incorrect CRC value is calculated or when there is an initialization error.

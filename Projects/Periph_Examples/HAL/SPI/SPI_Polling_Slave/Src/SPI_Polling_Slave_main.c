...
/**
 * @file  SPI_Polling_Slave/SPI_Polling_Slave_main.c
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\SPI\\SPI_Polling_Slave\\MDK-ARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\SPI_Polling_Slave.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\SPI\\SPI_Polling_Slave\\EWARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\SPI_Polling_Slave.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\SPI\\SPI_Polling_Slave\\WiSE-Studio\\{STEVAL-IDB011V1|STEVAL-IDB012V1}</tt> 
  -# Select desired configuration to build
...
|     DL3    |    ON: error - Blinking: timeout error   |    ON: error - Blinking: timeout error   |    ON: error - Blinking: timeout error   |
...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |  Start the communication through IT on master board  |  Start the communication through IT on master board  |  Start the communication through IT on master board  |
...
/* Includes ------------------------------------------------------------------*/
#include "SPI_Polling_Slave_main.h"
...
int main(void)
{
  ...
  switch(HAL_SPI_TransmitReceive(&hspiSlave, (uint8_t*)aTxBuffer, (uint8_t *)aRxBuffer, ubNbDataToTransmit, 10000))
  {
    case HAL_OK:

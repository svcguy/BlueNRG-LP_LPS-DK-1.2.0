...
* File Name          : SPI_IT_Master_main.c
...
/**
 * @file  SPI_IT_Master/SPI_IT_Master_main.c
 * @brief Data buffer transmission/reception between two boards via SPI using Interrupt mode (CPOL = 1 ; CPHA =0 ; NSSP =1).
 *
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\SPI\\SPI_IT_Master\\MDK-ARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\SPI_IT_Master.uvprojx</tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\SPI\\SPI_IT_Master\\EWARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\SPI_IT_Master.eww</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\SPI\\SPI_IT_Master\\WiSE-Studio\\{STEVAL-IDB011V1|STEVAL-IDB012V1}</tt> 
  -# Select desired configuration to build
...
|     DL2    |  Fast blinking: waiting User push-button (PUSH1) to be pressed - ON: transmission process is complete and reception process is complete  |  Fast blinking: waiting User push-button (PUSH1) to be pressed - ON: transmission process is complete and reception process is complete  |  Fast blinking: waiting User push-button (PUSH1) to be pressed - ON: transmission process is complete and reception process is complete  |
...
The SPI Clock Polarity is set to high.  
The SPI Clock Phase is set to first edge.
The SPI NSS Pulse Mode is enabled.
SPI_CR_CPOL=1
SPI_CR_CPHA=0
SPI_CR2_NSSP=1
...
If the Master board is used, the project SPI_IT_Master must be used.
If the Slave board is used, the project SPI_IT_Slave must be used.
...
- Connect Master board SPI NSS  pin to Slave Board SPI NSS  pin
...
uint16_t aTxBuffer[] = {0x1111,0x2222,0x3333,0x4444,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xAAAA,0xFFFF,0xBBBB,0xCCCC};
...
/* Buffer used for transmission */
__attribute((aligned(4))) uint8_t aTxBuffer[] = {0x11,0x22,0x33,0x44,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0x00,0xFF,0xBB,0xCC};
...
int main(void)
{
  ...
  if(HAL_SPI_TransmitReceive_IT(&hspiMaster, (uint8_t*)aTxBuffer, (uint8_t *)aRxBuffer, ubNbDataToTransmit) != HAL_OK)
  {
...
static void MX_SPI_MASTER_Init(void)
{
...
#endif 
  hspiMaster.Init.NSS = SPI_NSS_HARD_OUTPUT;
  ...
  hspiMaster.Init.NSSPMode = SPI_NSS_PULSE_ENABLE;

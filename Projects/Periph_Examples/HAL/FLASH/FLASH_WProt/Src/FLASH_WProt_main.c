...
/**
 * @file  FLASH_WProt/FLASH_WProt_main.c
 * @brief This example demonstrates how to use the basic Flash operation such as erase/write/read
 *
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\FLASH\\FLASH_WProt\\EWARM\\{STEVAL-IDB011V1|STEVAL-IDB012V1}\\FLASH_WProt.eww/</tt>
  -# Select desired configuration to build
...
* \section WISE_project WiSE-Studio project
  ...
  -# Select File, Import, Existing Projects into Workspace
     <tt>C:\\Users\\{username}\\ST\\BlueNRG-LP_LPS DK x.x.x\\Projects\\Periph_Examples\\HAL\\FLASH\\FLASH_WProt\\WiSE-Studio\\{STEVAL-IDB011V1|STEVAL-IDB012V1}</tt> 
  -# Select desired configuration to build
...
How to configure and use the FLASH HAL API to protect a group of the main flash page.
...
Before programming the page protection, an erase operation is performed using the flash erase  feature. 
The erase procedure is done by filling the erase init structure giving the starting erase  and the number of s to erase.
After the erase, using the HAL API HAL_FLASHEx_PageProtection, the page erase protection will be enabled for Flash pages 126 and 127.

Once this operation is finished, LED3 switch on to indicate that isn't allowed to write the page 126.
...
{  
  ...
  printf("Page Protection function from write and page erase.\n\r");
  ...
  printf("No errors after data programming.\n\r");
  BSP_LED_On(BSP_LED2);
